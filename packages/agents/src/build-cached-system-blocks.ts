...
/**
 * Shared by every persona-scoped system-prompt call site (`buildPersonaSystemPrompt`,
 * `composeTicketDraft`, `composeConfirmingQuestionLeadIn`, BUILD_PLAN 5.3a-ii). Drops
 * `undefined`/empty segments, then marks only the *last* remaining block `cache_control`.

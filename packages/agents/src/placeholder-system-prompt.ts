// Deliberately generic, non-persona voice — the real persona character (packages/agents/src/
// personas/*/prompt.md) is Stage 5 behind the do-not-touch gate (CLAUDE.md §Non-obvious
// constraints). This file lives outside that gated path on purpose, per BUILD_PLAN 2.4a.

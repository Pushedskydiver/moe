...
persona has kicks in for you here too. Lead with the action: you're drafting this, then the specific
line(s) that told you so. A draft is reversible and correctable by design, so don't write it as more
certain or complete than it actually is — and if it's also a case you'd otherwise decline, drafting

...
export const scenarios: readonly ReplayScenario[] = [
  ...
  },
  {
    ...
    description:
      ...
      'substantive reply. Deliberately phrased as retrospective thanks about an already-resolved ' +
      'incident, not a fresh "tests pass" completion claim — her own skepticism about unverified ' +
      'test-pass claims (see `passing-test-isnt-evidence-unless-it-would-have-failed-before` ' +
      'above) would rightly make her question the latter shape instead of acknowledging it.',
    input: {
      text: 'thanks for catching that edge case earlier — saved us a bad release.',
    },

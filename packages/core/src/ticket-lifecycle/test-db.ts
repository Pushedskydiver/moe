...
export async function resetDatabase(pool: Pool): Promise<void> {
  await pool.query(
    'DROP TABLE IF EXISTS tickets, schema_migrations, conversation_turns, persona_cost_daily, persona_cost_alerts, pending_ticket_drafts, review_queue, pending_confirming_questions',
  );
}

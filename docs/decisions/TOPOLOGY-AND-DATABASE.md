...
- **Neon offers point-in-time-recovery/branching** as part of its managed service — chunk 4.6 verified current retention-window specifics live and built the backup/restore story on it (`docs/OPERATIONS.md`).

...
// this file's DM-path tests never exercise it directly — it has its own co-located
// `log-ambient-intake-to-review-queue.test.ts` since 3.9, with the Low-band integration coverage in
